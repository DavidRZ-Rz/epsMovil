  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.titulo}>Detalle de la Especialidad</Text>
      ...
      <Card>
        ...
        <View style={styles.item}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.valor}>{especialidad.descripcion}</Text>
          </View>
        </View>
        ...
        <View style={[styles.item, { borderBottomWidth: 0 }]}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.valor}>{especialidad.duracion}</Text>
          </View>
        </View>
      </Card>
